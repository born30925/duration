...
calculateDate
```
###  กรณีให้ package อื่นๆสามารถเรียกใช้ฟังก์ชันได้
```
CalculateDate
```
* Golang จะเรียกใช้ฟังก์ชันของ Package อื่นฟังก์ชันนั้นต้องขึ้นต้นด้วยตัวพิมพ์ใหญ่ ถ้าขึ้นต้นด้วยตัวพิมพ์เล็กจะเรียกใช้ไม่ได้
